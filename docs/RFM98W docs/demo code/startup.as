	...
	; Compiler options:
	;
	; -oRFDK_RFM98_V2.1.cof -mRFDK_RFM98_V2.1.map --summary=default \
	; --output=default DK_Flash.p1 DK_LCD.p1 DK_PIC16_App.p1 DK_RFM98.p1 \
	; DK_SPI.p1 main.p1 --chip=16F1519 -P --runtime=default --opt=default \
