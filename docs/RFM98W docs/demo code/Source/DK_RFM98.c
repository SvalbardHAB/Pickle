...
**********************************************************/
#define RFM98_PORchk_In  TRISD0=1   
#define RFM98_PORchk_Out TRISD0=0  
#define RFM98_PORchkin   RD0  
#define RFM98_PORchkout  LATD0      
/**********************************************************
**Parameter table define
**********************************************************/
...
const u8  RFM98Data[] = {"HopeRF RFM COBRFM98-S"};
...
void RFM98_Config(u8 mode)
{
  ...
  RFM98_PORchk_Out;
  RFM98_PORchkout=0;                                       //Ver1.1 (Change for Reset)
